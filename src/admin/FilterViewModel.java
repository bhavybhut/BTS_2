...
public class FilterViewModel implements Composer{
    ...
    @Command
    public void delete(@BindingParam("userStatus") final UserStatus us){
    	Messagebox.show("Are you sure you want to delete this record?","Question",
    			...
    			new org.zkoss.zk.ui.event.EventListener(){
					...
					public void onEvent(Event event) throws Exception {
						...
						if(Messagebox.ON_YES.equals(event.getName())){
							Map<String,Object> map = new HashMap<String,Object>();
							user = (User)map.put("userModel",us.getUser());
							JdbcComposer composer = new JdbcComposer();
							System.out.println("Object Created");
							composer.deleteUser(user);
						}
						else if(Messagebox.ON_NO.equals(event.getName())){}
					}
